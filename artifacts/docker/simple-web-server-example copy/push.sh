...
docker tag fredlackey/simpleweb:0.0.0 123456789012.dkr.ecr.us-west-1.amazonaws.com/simpleweb:0.0.0
docker tag fredlackey/simpleweb:0.0.0 123456789012.dkr.ecr.us-west-1.amazonaws.com/simpleweb:latest
aws ecr get-login-password | docker login --username AWS --password-stdin 123456789012.dkr.ecr.us-west-1.amazonaws.com
docker push 123456789012.dkr.ecr.us-west-1.amazonaws.com/simpleweb:0.0.0
docker push 123456789012.dkr.ecr.us-west-1.amazonaws.com/simpleweb:latest

# $ ./push.sh 
# Login Succeeded
# The push refers to repository [123456789012.dkr.ecr.us-west-1.amazonaws.com/simpleweb]
# 5dbcb249607a: Pushed
# 5f70bf18a086: Pushed
# 36eb1b463826: Pushed
# 291cc65d7cfb: Pushed
