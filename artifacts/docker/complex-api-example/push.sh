...
docker tag fredlackey/complexapi:0.0.0 138563826014.dkr.ecr.us-west-1.amazonaws.com/complexapi:0.0.0
docker tag fredlackey/complexapi:0.0.0 138563826014.dkr.ecr.us-west-1.amazonaws.com/complexapi:latest
aws ecr get-login-password | docker login --username AWS --password-stdin 138563826014.dkr.ecr.us-west-1.amazonaws.com
docker push 138563826014.dkr.ecr.us-west-1.amazonaws.com/complexapi:0.0.0
docker push 138563826014.dkr.ecr.us-west-1.amazonaws.com/complexapi:latest

# $ ./push.sh 
# Login Succeeded
# The push refers to repository [138563826014.dkr.ecr.us-west-1.amazonaws.com/complexapi]
# 5dbcb249607a: Pushed
# 5f70bf18a086: Pushed
# 36eb1b463826: Pushed
# 291cc65d7cfb: Pushed
